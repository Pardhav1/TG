document.addEventListener("DOMContentLoaded", () => {
  ...
  async function handleLogout() {
    try {
      ...
      const res = await fetch("https://tripguru.onrender.com/api/auth/logout", {
        method: "POST",
        headers: {
  ...
  async function checkAuth() {
    ...
    try {
      const res = await fetch(
        "https://tripguru.onrender.com/api/auth/profile",
        {
          method: "GET",
          headers: {
            Authorization: `Bearer ${token}`,
...
async function fetchTripDetails(event) {
  ...
  try {
    const response = await fetch(
      "https://tripguru.onrender.com/api/ai/expense",
      {
        method: "POST",
        headers: {
